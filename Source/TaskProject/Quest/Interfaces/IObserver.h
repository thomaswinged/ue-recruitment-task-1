...
public:
	...
	void OnObservableEvent(UObject* Subject, TSubclassOf<UObservableEvent> Event);
	virtual void OnObservableEvent_Implementation(UObject* Subject, TSubclassOf<UObservableEvent> Event)
	{
